...
extern void COMEX_init_ENV(int node_ID, int n_nodes, int writeOut_buff, int readIn_buff, int total_pages, int threshold, int refill, int nComNodes, char *namePtr);
